...
const Dining = () => {
  ...
  const [diningsnapshot, dineloading, dineerror] = useCollection(
    firebase.firestore().collection("store").where("category", "array-contains", "cafe")
  );
          ...
          <div className="row ">
            <div className="col-md-6 ">
              <div>
                ...
                >
                  <span style={{ color: "#F04937" }}>SPICE UP YOUR</span> <br />
            ...
            <div className="col-md-6">
              <img
                src="https://assets.codepen.io/1729459/coffee.jpg"
                width="100%"
              />
            </div>
        ...
        {diningsnapshot?.docs?.map((item) => (
          ...
          <div className="row my-5 d-flex justify-content-center">
            <div className="col-md-4 d-flex justify-content-center my-3">
              <div className="">
                <img src={item?.data()?.image_url}  width="150px" />
              </div>
            </div>
